...
--
-- Name: properties_backup; Type: TABLE; Schema: public; Owner: freecodecamp
--

CREATE TABLE public.properties_backup (
    atomic_number integer,
    type character varying(30),
    atomic_mass numeric(20,10),
...
ALTER TABLE public.properties_backup OWNER TO freecodecamp;
...
--
-- Data for Name: properties_backup; Type: TABLE DATA; Schema: public; Owner: freecodecamp
--

INSERT INTO public.properties_backup VALUES (1, 'nonmetal', 1.0080000000, -259.1, -252.9, 1);
INSERT INTO public.properties_backup VALUES (2, 'nonmetal', 4.0026000000, -272.2, -269, 1);
INSERT INTO public.properties_backup VALUES (6, 'nonmetal', 12.0110000000, 3550, 4027, 1);
INSERT INTO public.properties_backup VALUES (7, 'nonmetal', 14.0070000000, -210.1, -195.8, 1);
INSERT INTO public.properties_backup VALUES (8, 'nonmetal', 15.9990000000, -218, -183, 1);
INSERT INTO public.properties_backup VALUES (3, 'metal', 6.9400000000, 180.54, 1342, 2);
INSERT INTO public.properties_backup VALUES (4, 'metal', 9.0122000000, 1287, 2470, 2);
INSERT INTO public.properties_backup VALUES (5, 'metalloid', 10.8100000000, 2075, 4000, 3);
INSERT INTO public.properties_backup VALUES (1000, 'metalloid', 1.0000000000, 10, 100, 3);
